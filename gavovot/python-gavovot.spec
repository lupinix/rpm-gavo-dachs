...
%global srcname gavovot
%global sum A library to read and write VOTables, plus a TAP client 
%global common_desc A library to read and write VOTables, plus a TAP client.
